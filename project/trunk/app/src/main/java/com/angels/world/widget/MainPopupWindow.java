...
public class MainPopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    private ImageView iv_add, iv_push_teacher_faker, iv_push_student_faker, iv_push_teacher, iv_push_student;
    ...
    public MainPopupWindow(Activity activity, OnPopWindowClickListener listener) {
    ...
    private void initViewSetting(Activity context) {
        ...
        mMenuView = inflater.inflate(R.layout.pop_main_add, null);


        iv_add = (ImageView) mMenuView.findViewById(R.id.dd5);
        iv_add.setOnClickListener(this);

        iv_push_student = (ImageView) mMenuView.findViewById(R.id.iv_push_student);
        iv_push_student.setOnClickListener(this);

        iv_push_teacher = (ImageView) mMenuView.findViewById(R.id.iv_push_teacher);
        iv_push_teacher.setOnClickListener(this);

        iv_push_teacher_faker = (ImageView) mMenuView.findViewById(R.id.iv_push_resale_faker);
        iv_push_student_faker = (ImageView) mMenuView.findViewById(R.id.iv_push_photo_faker);
    ...
    private void startAnimation() {
        ...
        rotateAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                iv_push_student_faker.getLocationOnScreen(location);
                defwightTvPhoto = location[0];
                defheightTvPhoto = location[1];

                //之后的右边图片
                int location1[] = new int[2];
                iv_push_teacher.getLocationOnScreen(location1);
                ...
                iv_push_student.getLocationOnScreen(location2);
                wightTvPhoto = location2[0];
                heightTvPhoto = location2[1];

                //默认右的图片位置
                int location3[] = new int[2];
                iv_push_teacher_faker.getLocationOnScreen(location3);
                ...
                iv_push_student_faker.startAnimation(sa);
                sa.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    @Override
                    public void onAnimationEnd(Animation animation) {
                        iv_push_student_faker.setVisibility(View.GONE);
                        iv_push_student.setVisibility(View.VISIBLE);
                    }
                ...
                iv_push_teacher_faker.startAnimation(sa1);
                sa1.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    @Override
                    public void onAnimationEnd(Animation animation) {
                        iv_push_teacher_faker.setVisibility(View.GONE);
                        iv_push_teacher.setVisibility(View.VISIBLE);
                    }
    ...
    private void exitAnimation() {
        ...
        iv_push_student.startAnimation(sa);
        sa.setAnimationListener(new Animation.AnimationListener() {
            @Override
            public void onAnimationStart(Animation animation) {
            ...
            @Override
            public void onAnimationEnd(Animation animation) {
                iv_push_student.setVisibility(View.GONE);
                iv_push_teacher.setVisibility(View.GONE);
                dismiss();
            }
        ...
        iv_push_teacher.startAnimation(sa2);
