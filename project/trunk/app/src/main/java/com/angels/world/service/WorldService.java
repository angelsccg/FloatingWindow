...
import com.angels.world.floatActor.RabbitView;
...
public class WorldService extends Service implements StepSensorBase.StepCallBack{
    ...
    /**小兔子*/
    private static RabbitView rabbitView;
    ...
    private StrongService startS2 = new StrongService.Stub() {
        ...
        public void stopService() throws RemoteException {
            Intent i = new Intent(getBaseContext(), WorldProtectService.class);
            ...
            public void run() {
                while (true) {
                    boolean isRun = AppUtil.isServiceWork(WorldService.this,
                            "com.angels.floatwindow.service.WorldProtectService");
                    if (!isRun) {
...
//        menuView.setVisibility(View.INVISIBLE);
        ...
        rabbitView = new RabbitView(this,wmParams);
        rabbitView.setImageResource(R.drawable.anim_rabbit_eat_left);
        rabbitView.start();
        wmParams.x = screenWeight/2;
        wmParams.y = screenHeight/2;
        rabbitView.setXY(wmParams.x,wmParams.y);
        wm.addView(rabbitView, wmParams);
...
//            }
//        });
        rabbitView.setOnTouchEventRabbitListener(rabbitListener);
    }

    /**主角监听*/
    RabbitView.OnTouchEventRabbitListener rabbitListener = new RabbitView.OnTouchEventRabbitListener() {
        @Override
        public void onTouchEvent(MotionEvent event) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN: // 捕获手指触摸按下动作
                ...
                case MotionEvent.ACTION_UP://捕获手指触摸离开动作
                    ...
                    if(isRrash(x,y,floatSurfaceView)){
                        AcToastUtil.showShort(WorldService.this,"睡觉去啦");
    ...
    FloatSurfaceView.OnTouchEventHouseListener houseListener = new FloatSurfaceView.OnTouchEventHouseListener() {
        ...
        public void onWalkUp() {
            rabbitView.setVisibility(View.VISIBLE);
            rabbitView.updateViewPosition(floatSurfaceView.x + floatSurfaceView.getWidth()/2,floatSurfaceView.y + floatSurfaceView.getHeight()/3*2);
        }
        ...
        @Override
        public void onSleep() {
            rabbitView.setVisibility(View.INVISIBLE);
        }
    };
