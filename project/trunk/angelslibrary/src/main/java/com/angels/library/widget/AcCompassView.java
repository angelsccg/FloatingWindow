 ...
 *  指南针
 */
public class AcCompassView extends View {
    ...
    public AcCompassView(Context context) {
    ...
    public AcCompassView(Context context, @Nullable AttributeSet attrs) {
    ...
    public AcCompassView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        mDeepGrayPaint.setColor(context.getResources().getColor(R.color.deepGray));
        mDeepGrayPaint.setColor(context.getResources().getColor(R.color.darkgrey));
...
//        mLightGrayPaint.setColor(context.getResources().getColor(R.color.lightGray));
        mLightGrayPaint.setColor(context.getResources().getColor(R.color.lightgrey));
...
//        mOutSideCircumPaint.setColor(context.getResources().getColor(R.color.lightGray));
        mOutSideCircumPaint.setColor(context.getResources().getColor(R.color.lightgrey));
...
//        mSamllDegreePaint.setColor(context.getResources().getColor(R.color.lightGray));
        mSamllDegreePaint.setColor(context.getResources().getColor(R.color.lightgrey));
